:: Se mueve a la carpeta donde esta instalado MongoDB y ejecuta el "demonio" de mongo, indicandole con --dbpath la ruta donde estará la BD
start cmd.exe /k "cd C:\Program Files\MongoDB\Server\6.0\bin && mongod.exe --dbpath C:\Program Files\MongoDB\Server\6.0\data"
